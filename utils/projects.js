export const projects = [
  {
    name: 'Location-Based Event Fetching Website',
    technologiesUsed: [
      'React.js',
      'Node.js',
      'MongoDB',
  ...
  {
    name: 'Doctor-Patient Appointment Management Portal',
    technologiesUsed: ['React.js', 'Firebase', 'Material-UI'],
    overview:
  ...
  {
    name: 'Stable.trade Cryptocurrency Exchange',
    technologiesUsed: [
      'React.js',
      'Node.js',
      'Go',
  ...
  {
    name: 'DafriXchange Cryptocurrency Exchange',
    technologiesUsed: [
      'React.js',
      'Node.js',
      'Go',
